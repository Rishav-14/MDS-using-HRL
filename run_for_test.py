...
parser.add_argument("--simulate_epoch_number", dest="simulate_epoch_number", type=int, default = 3, help="The number of simulate epoch.")
...
parser.add_argument("--evaluate_session_number", dest="evaluate_session_number", type=int, default=100, help="the size of each simulate epoch when evaluation.")
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../../model/DQN/checkpoint/0114141450_agenthrljoint2_T22_ss100_lr0.0005_RFS66_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-66_mls0_gamma0.95_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_data_RID0/model_d10agenthrljoint2_s0.554_r22.616_t19.304_mr0.11_mr2-0.315_e-3118.pkl")
